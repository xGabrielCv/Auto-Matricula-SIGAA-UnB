...
class TelaAvancado(ttk.Frame):
    ...
    def _restaurar_selecionadas(self):
        ...
        self.app.salvar_settings()
        messagebox.showinfo("Restaurado", "Seções restauradas. Reabra a tela para ver os novos valores.")
    ...
    def _restaurar_tudo(self):
        ...
        self.app.salvar_settings()
        messagebox.showinfo("Restaurado", "Todas as configurações foram restauradas. Reabra a tela para ver os novos valores.")
    ...
    def _importar(self):
        ...
        messagebox.showinfo("Importado", "Configurações importadas. Reabra a tela para ver os novos valores.")
